...
function EncodeMessage(Msg: TDefaultMessage): AnsiString; overload;

function EncodeMessage(Msg: TDefaultMessage; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function DecodeMessage(const S: AnsiString): TDefaultMessage; overload;

function DecodeMessage(Src: PAnsiChar; SrcLen: Integer): TDefaultMessage; overload;

//-----------------------------------------------------------------------------------
function EncodeString(const S: AnsiString): AnsiString; overload;

function EncodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function EncodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function EncodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function DecodeString(const S: AnsiString): AnsiString; overload;

function DecodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function DecodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function DecodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

//-----------------------------------------------------------------------------------
function EncodeStringK(const S: AnsiString): AnsiString;

function DecodeStringK(const S: AnsiString): AnsiString;
//-----------------------------------------------------------------------------------

function zEncodeString(const S: AnsiString): AnsiString; overload;

function zEncodeString(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function zDecodeString(const S: AnsiString): AnsiString; overload;

function zDecodeString(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function zEncodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;

function zDecodeBuffer(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;

//-----------------------------------------------------------------------------------

function zLibEncodeString(const S: AnsiString): AnsiString; overload;

function zLibEncodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function zLibEncodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function zLibEncodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function zLibDecodeString(const S: AnsiString): AnsiString; overload;

function zLibDecodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function zLibDecodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function zLibDecodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

//-----------------------------------------------------------------------------------
function zLibCompressString(const S: AnsiString): AnsiString; overload;

function zLibCompressString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function zLibCompressBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function zLibCompressBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function zLibDecompressString(const S: AnsiString): AnsiString; overload;

function zLibDecompressString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer; overload;

function zLibDecompressBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString; overload;

function zLibDecompressBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer; overload;
...
function EncodeMessage(Msg: TDefaultMessage): AnsiString;
begin
  SetLength(Result, GetEncodeSize(SizeOf(TDefaultMessage)));
  Encode6BitBuf(@Msg, @Result[1], SizeOf(Msg), Length(Result));
end;

function EncodeMessage(Msg: TDefaultMessage; Dest: PAnsiChar; DestLen: Integer): Integer;
begin
  Result := Encode6BitBuf(@Msg, Dest, SizeOf(Msg), DestLen);
end;

function DecodeMessage(const S: AnsiString): TDefaultMessage;
begin
  if Length(S) = 0 then
    Exit;
...
function DecodeMessage(Src: PAnsiChar; SrcLen: Integer): TDefaultMessage;
begin
  if SrcLen = 0 then
    Exit;
...
function EncodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;
begin
  if Length(S) = 0 then
  begin
    Result := 0;
...
function EncodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;
begin
  if SrcLen = 0 then
  begin
    Result := '';
...
function EncodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer;
begin
  if SrcLen = 0 then
  begin
    Result := 0;
...
function DecodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;
begin
  if Length(S) = 0 then
  begin
    Result := 0;
...
function DecodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;
begin
  if SrcLen = 0 then
  begin
    Result := '';
...
function DecodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer;
begin
  if SrcLen = 0 then
  begin
    Result := 0;
...
function zEncodeString(const S: AnsiString): AnsiString;
begin
  Result := EncodeString(S);
end;

function zEncodeString(Src: PAnsiChar; SrcLen: Integer): AnsiString;
begin
  Result := EncodeBuffer(Src, SrcLen);
end;

function zDecodeString(const S: AnsiString): AnsiString;
begin
  Result := DecodeString(S);
end;

function zDecodeString(Src: PAnsiChar; SrcLen: Integer): AnsiString;
begin
...
function zLibEncodeString(const S: AnsiString): AnsiString;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibEncodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibEncodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibEncodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibDecodeString(const S: AnsiString): AnsiString;
var
  DecodeBuf: PAnsiChar;
...
function zLibDecodeString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  DecodeBuf: PAnsiChar;
  DecodeBufSize: Integer;
  zLibBuf: PAnsiChar;
...
function zLibDecodeBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;
var
  DecodeBuf: PAnsiChar;
  DecodeBufSize: Integer;
  zLibBuf: PAnsiChar;
...
function zLibDecodeBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  DecodeBuf: PAnsiChar;
  DecodeBufSize: Integer;
  zLibBuf: PAnsiChar;
...
function zLibCompressString(const S: AnsiString): AnsiString;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibCompressString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibCompressBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibCompressBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibDecompressString(const S: AnsiString): AnsiString;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibDecompressString(const S: AnsiString; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibDecompressBuffer(Src: PAnsiChar; SrcLen: Integer): AnsiString;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
...
function zLibDecompressBuffer(Src: PAnsiChar; SrcLen: Integer; Dest: PAnsiChar; DestLen: Integer): Integer;
var
  zLibBuf: PAnsiChar;
  zLibBufSize: Integer;
begin
