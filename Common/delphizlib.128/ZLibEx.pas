...
begin
  ...
  Move(buffer, Pointer(NativeInt(param^.OutBuffer) + param^.OutPosition)^, size);
...
begin
  ...
  begin
    ...
    Move(buffer^, Pointer(NativeInt(FBuffer) + FBufferSize)^, size);
...
begin
  ...
  begin
    ...
    Move(Pointer(NativeInt(FBuffer) + size)^, FBuffer^, FBufferSize - size);
