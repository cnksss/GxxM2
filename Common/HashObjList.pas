...
type
  ...
  public
    ...
    function Add(const Name: string; Item: Pointer): Boolean;
    property MaxCount: Integer read GetCount;
    property Count: Integer read FRecordCount;
    property Objects[Index: Integer]: Pointer read Get write Put;
  end;
...
function THashObjectList.Get(Index: Integer): Pointer;
begin
  if Buckets[Index] <> nil then
    Result := PHashItem(Buckets[Index]).Item
  else
    Result := nil;
end;

procedure THashObjectList.Put(Index: Integer; Value: Pointer);
begin
  if Buckets[Index] <> nil then
    PHashItem(Buckets[Index]).Item := Value;
end;

function THashObjectList.IndexOf(const Name: string): Integer;
begin
...
constructor THashObjectList.Create(Size: Integer);
begin
  inherited Create;
  FSize := Size;
...
function THashObjectList.Find(const Name: string): PPHashItem;
var
  Hash: Integer;
begin
...
function THashObjectList.HashOf(const Name: string): Cardinal;
// var
// I: Integer;
begin
...
function THashObjectList.Add(const Name: string; Item: Pointer): Boolean;
var
  Hash: Integer;
  Bucket: PHashItem;
begin
...
function THashObjectList.Modify(const Name: string; Value: string): Boolean;
var
  P: PHashItem;
begin
  P := Find(Name)^;
...
procedure THashObjectList.Delete(Index: Integer);
var
  P: PHashItem;
  Prev: PPHashItem;
begin
...
procedure THashObjectList.Remove(const Name: string);
{var
  Hash: Integer;
  Prev: PPHashItem;
begin
