{ --------------------------------------------------------- }
{
  update: 2020-12-14 support delphi XE; chongchong
}
{ --------------------------------------------------------- }
...
procedure BFEncryptString(const InString : AnsiString; var OutString : AnsiString;
            const Key : TKey128; Encrypt : Boolean);
procedure BFEncryptStringCBC(const InString : AnsiString; var OutString : AnsiString;
            const Key : TKey128; Encrypt : Boolean);
procedure DESEncryptString(const InString : AnsiString; var OutString : AnsiString;
            const Key : TKey64; Encrypt : Boolean);
procedure DESEncryptStringCBC(const InString : AnsiString; var OutString : AnsiString;
            const Key : TKey64; Encrypt : Boolean);
procedure TripleDESEncryptString(const InString : AnsiString; var OutString : AnsiString;
            const Key : TKey128; Encrypt : Boolean);
procedure TripleDESEncryptStringCBC(const InString : AnsiString; var OutString : AnsiString;
            const Key : TKey128; Encrypt : Boolean);
procedure RDLEncryptString(const InString : AnsiString; var OutString : AnsiString;
            const Key; KeySize : Longint; Encrypt : Boolean);
procedure RDLEncryptStringCBC(const InString : AnsiString; var OutString : AnsiString;
            const Key; KeySize : Longint; Encrypt : Boolean);

function BFEncryptStringEx(const InString : AnsiString;
            const Key : TKey128; Encrypt : Boolean) : AnsiString;
function BFEncryptStringCBCEx(const InString : AnsiString;
            const Key : TKey128; Encrypt : Boolean) : AnsiString;
function DESEncryptStringEx(const InString : AnsiString;
            const Key : TKey64; Encrypt : Boolean) : AnsiString;
function DESEncryptStringCBCEx(const InString : AnsiString;
            const Key : TKey64; Encrypt : Boolean) : AnsiString;
function TripleDESEncryptStringEx(const InString : AnsiString;
            const Key : TKey128; Encrypt : Boolean) : AnsiString;
function TripleDESEncryptStringCBCEx(const InString : AnsiString;
            const Key : TKey128; Encrypt : Boolean) : AnsiString;
function RDLEncryptStringEx(const InString : AnsiString;
            const Key; KeySize : Longint; Encrypt : Boolean) : AnsiString;
function RDLEncryptStringCBCEx(const InString : AnsiString;
            const Key; KeySize : Longint; Encrypt : Boolean) : AnsiString;
