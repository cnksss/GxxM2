...
procedure EncryptDes(const Indata; var Outdata; Size: Longint; const Key: AnsiString);
procedure DecryptDes(const Indata; var Outdata; Size: Longint; const Key: AnsiString);
function EncryptStrDes(const Source, Key: AnsiString): AnsiString;
function DecryptStrDes(const Source, Key: AnsiString): AnsiString;
function DecryStringHex(StrHex, Key: AnsiString): AnsiString;
function EncryStringHex(StrHex, Key: AnsiString): AnsiString;

procedure EncryptCBC(const Indata; var Outdata; Size: Longint; Chain: PByteArray; KeyData: PDWordArray);
procedure DecryptCBC(const Indata; var Outdata; Size: Longint; Chain: PByteArray; KeyData: PDWordArray);

procedure EncryptCBC3(const Indata; var Outdata; Size: Longint; Chain: PByteArray; KeyData: PDWordArray);
procedure DecryptCBC3(const Indata; var Outdata; Size: Longint; Chain: PByteArray; KeyData: PDWordArray);

procedure GetKeyData(const Key: AnsiString; Chain: PByteArray; KeyData: PDWordArray);

// PAK密码专用 piaoyun 2013-08-27
procedure GetKeyDataPak(const Key: AnsiString; Chain: PByteArray; KeyData: PDWordArray);

procedure GetKeyDataPak2(const Key: AnsiString; Chain: PByteArray; KeyData: PDWordArray);

var
  PakEncryKey: PLongWord;
  NewEncryKey: PLongWord;
  PakEncryKey2: PLongWord;
...
const
  ...
  des_skb2: array[0..7, 0..63] of dword = (
    (
    (* for C bits (numbered as per FIPS 46) 1 2 3 4 5 6 *)
    $00000000, $00000010, $20000000, $20000010,
    $00010000, $00010010, $20010000, $20010010,
    ...
    $10000400, $12000400, $10002400, $12002400,
    $10200400, $12200400, $10202400, $12202400,
    $10000404, $12000402, $10002404, $12002404,
    $10200404, $12200402, $10202404, $12202404
    ), (
    (* for C bits (numbered as per FIPS 46) 14 15 16 17 19 20 *)
    $00000000, $00000001, $00040000, $00040001,
    $01000000, $01000001, $01040000, $01040001,
    ...
    $08000002, $08000003, $08040002, $08040003,
    $09000002, $09000003, $09040002, $09040003,
    $08000200, $08000203, $08040200, $08040201,
    $09000200, $09000203, $09040200, $09040201,
    $08000202, $08000201, $08040202, $08040203,
    $09000202, $09000201, $09040202, $09040203
    ), (
    (* for C bits (numbered as per FIPS 46) 21 23 24 26 27 28 *)
    $00000000, $00100000, $00000100, $00100100,
    $00000008, $00100008, $00000108, $00100108,
    ...
    $00020008, $00120008, $00020108, $00120108,
    $00021000, $00121000, $00021100, $00121100,
    $00021008, $00121008, $00021104, $00121108,
    $04020000, $04120000, $04020100, $04120100,
    $04020008, $04120008, $04020108, $04120108,
    $04021000, $04121000, $04021100, $04121100,
    $04021008, $04121008, $04021104, $04121108
    ), (
    (* for D bits (numbered as per FIPS 46) 1 2 3 4 5 6 *)
    $00000000, $10000000, $00010000, $10010000,
    $00000004, $10000004, $00010004, $10010004,
    ...
    $20100004, $30100004, $20110004, $30110004,
    $00001000, $10001000, $00011000, $10011000,
    $00001004, $10001004, $00011008, $10011004,
    $20001000, $30001000, $20011000, $30011000,
    $20001004, $30001004, $20011004, $30011004,
    $00101000, $10101000, $00111000, $10111000,
    $00101004, $10101004, $00111008, $10111004,
    $20101000, $30101000, $20111000, $30111000,
    $20101004, $30101004, $20111004, $30111004
    ), (
    (* for D bits (numbered as per FIPS 46) 8 9 11 12 13 14 *)
    ...
    $00020401, $08020401, $00020409, $08020409,
    $02000000, $0A000000, $02000008, $0A000008,
    $02000400, $0A000400, $02000404, $0A000408,
    $02020000, $0A020000, $02020008, $0A020008,
    $02020400, $0A020400, $02020408, $0A020408,
    $02000001, $0A000001, $02000009, $0A000009,
    $02000401, $0A000401, $02000409, $0A000409,
    ...
    $00000200, $00000300, $00080200, $00080300,
    $01000200, $01000300, $01080200, $01080300,
    $00000210, $00000310, $00080212, $00080310,
    $01000210, $01000310, $01080210, $01080310,
    $00200200, $00200300, $00280200, $00280300,
    $01200200, $01200300, $01280202, $01280300,
    $00200210, $00200310, $00280210, $00280310,
    $01200210, $01200310, $01280210, $01280310
    ), (
    (* for D bits (numbered as per FIPS 46) 22 23 24 25 27 28 *)
    ...
    $00000022, $04000022, $00040022, $04040022,
    $00002020, $04002020, $00042020, $04042020,
    $00002022, $04002022, $00042020, $04042022,
    $00000800, $04000800, $00040802, $04040800,
    $00000802, $04000802, $00040800, $04040802,
    $00002800, $04002800, $00042800, $04042800,
    $00002802, $04002802, $00042800, $04042802,
    $00000820, $04000820, $00040822, $04040820,
    $00000822, $04000822, $00040820, $04040822,
    $00002820, $04002820, $00042820, $04042820,
    $00002822, $04002822, $00042822, $04042822
    ));
...
procedure EncryptBlock3(const InData; var OutData; KeyData: PDWordArray);
begin
...
procedure DecryptBlock3(const InData; var OutData; KeyData: PDWordArray);
begin
...
procedure GetKeyData(const Key: AnsiString; Chain: PByteArray; KeyData: PDWordArray);
var
  IV: array[0..BS - 1] of Byte;                                                                     { Storage for the chaining information     }
...
begin
  ...
  begin
    if I mod 2 = 1 then
      Digest[I] := Digest[I - 1] xor Digest[I];
  end;
...
procedure GetKeyData3(const Key: AnsiString; Chain: PByteArray; KeyData0, KeyData1, KeyData2: PDWordArray);
var
  IV: array[0..BS - 1] of Byte;                                                                     { Storage for the chaining information     }
  Digest: array[0..19] of Byte;                                                                     { SHA1 produces a 20byte digest }
...
begin
  ...
  FillChar(KeyB, Sizeof(KeyB), 0);
  Move(Digest, KeyB, SizeOf(KeyB));
  DoInit(@KeyB[0], KeyData0);
  DoInit(@KeyB[1], KeyData1);

  FillChar(IV, BS, $8F);
  //FillChar(IV, BS, $6F);
  EncryptBlock3(IV, IV, KeyData0);
  Move(IV, Chain^, BS);
end;
...
begin
  ...
  if (Size mod BS) <> 0 then
  begin
    EncryptBlock3(Chain^, Chain^, KeyData);
    Move(p1^, p2^, Size mod BS);
    XorBlock(p2^, Chain^, Size mod BS);
  end;
end;
...
procedure EncryptDes3(const Indata; var Outdata; Size: Longint; const Key: AnsiString);
var
  KeyData: array[0..31] of DWord;
  Chain: array[0..BS - 1] of Byte;
begin
  GetKeyData(Key, @Chain, @KeyData);
  EncryptCBC3(Indata, Outdata, Size, @Chain, @KeyData);
end;

procedure DecryptDes3(const Indata; var Outdata; Size: Longint; const Key: AnsiString);
var
  KeyData: array[0..31] of DWord;
  Chain: array[0..BS - 1] of Byte;
begin
  GetKeyData(Key, @Chain, @KeyData);
  DecryptCBC3(Indata, Outdata, Size, @Chain, @KeyData);
end;

function EncryptStrDes(const Source, Key: AnsiString): AnsiString;
begin
  SetLength(Result, Length(Source));
  EncryptDes(Source[1], Result[1], Length(Source), Key);
end;

function DecryptStrDes(const Source, Key: AnsiString): AnsiString;
begin
  SetLength(Result, Length(Source));
  DecryptDes(Source[1], Result[1], Length(Source), Key);
end;
...
initialization
  begin
    ...
    New(PakEncryKey);
    New(PakEncryKey2);
    PakEncryKey^ := $0DC6DAC1E;
    NewEncryKey^ := $0C08BE531;
    PakEncryKey2^ := $03d5323f3;
  end;

finalization
  Dispose(NewEncryKey);
  Dispose(PakEncryKey);
  Dispose(PakEncryKey2);
