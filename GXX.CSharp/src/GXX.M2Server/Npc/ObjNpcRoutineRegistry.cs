...
public static class ObjNpcRoutineRegistry
{
    ...
    public static readonly Entry[] All =
    {
        ...
        new() { StartLine = 1674, EndLine = 1683, Signature = "procedure TMerchant.SaveUpgradingList();", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 3052, EndLine = 3061, Signature = "procedure TMerchant.LoadNPCData;", Status = "Missing", Home = "" },
        new() { StartLine = 3062, EndLine = 3070, Signature = "procedure TMerchant.SaveNPCData;", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 3180, EndLine = 3205, Signature = "procedure TMerchant.LoadNpcScript(IsAddMapName: Boolean = True);", Status = "Missing", Home = "" },
        new() { StartLine = 3206, EndLine = 3227, Signature = "procedure TMerchant.LoadNpcIconFile(IsAddMapName: Boolean = True);", Status = "Missing", Home = "" },
        new() { StartLine = 3228, EndLine = 3233, Signature = "procedure TMerchant.Click(PlayObject: TPlayObject); // 0049FF24", Status = "Missing", Home = "" },
        new() { StartLine = 3234, EndLine = 3271, Signature = "function TMerchant.GetVariableText(PlayObject: TPlayObject; var sMsg: string; sVariable: string; var IsBreakParseVar: Boolean; nPos: Integer): Boolean; // 0049FD04", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 3869, EndLine = 3893, Signature = "function TMerchant.AddItemToGoodsList(UserItem: pTUserItem): Boolean;", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 4164, EndLine = 4195, Signature = "procedure TMerchant.ClearScript;", Status = "Missing", Home = "" },
        new() { StartLine = 4196, EndLine = 4234, Signature = "procedure TMerchant.LoadUpgradeList;", Status = "Missing", Home = "" },
        new() { StartLine = 4235, EndLine = 4240, Signature = "procedure TMerchant.SendCustemMsg(PlayObject: TPlayObject; sMsg: string);", Status = "Missing", Home = "" },
        new() { StartLine = 4241, EndLine = 4281, Signature = "procedure TMerchant.ClearData;", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 6011, EndLine = 9262, Signature = "function TNormNpc.GetVariableText(PlayObject: TPlayObject; var sMsg: string; sVariable: string; var IsBreakParseVar: Boolean; nPos: Integer): Boolean;", Status = "Seam", Home = "NpcSeams.GetVariableText" },
        ...
        new() { StartLine = 9575, EndLine = 9592, Signature = "procedure TNormNpc.LoadNpcScript;", Status = "Missing", Home = "" },
        new() { StartLine = 9593, EndLine = 9603, Signature = "procedure TNormNpc.LoadNpcIconFile;", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 9837, EndLine = 9863, Signature = "procedure TNormNpc.SendCustemMsg(PlayObject: TPlayObject; sMsg: string);", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 10510, EndLine = 10515, Signature = "constructor TBoxMonster.Create;", Status = "Missing", Home = "" },
        ...
        new() { StartLine = 10527, EndLine = 10533, Signature = "function TBoxMonster.Operate(ProcessMsg: pTProcessMessage): Boolean;", Status = "Missing", Home = "" },
        new() { StartLine = 10534, EndLine = 10544, Signature = "procedure TBoxMonster.Run;", Status = "Missing", Home = "" },
    };
}
