...
//
// 已覆盖：前导段 3505-3519、CM_RUN 4694-5853（MirClientContextCheckUsePluginRunTests）、
//         CM_TURN 5855-6681（…TurnTests）、CM_SPELL 7886-8995（…SpellTests）、
//         CM_SITDOWN 8997-9469（…SitDownTests）、CM_DROPITEM 9474-9487、CM_PICKUP 9492-9505、
//         else 9506-9516、公共收尾 9521-9681（CheckUsePluginPostlude）、兜底 9682-9686。
// 未覆盖：CM_WALK 3528-4696、攻击族 6690-7888
...
public class MirClientContextCheckUsePluginTests
{
    ...
    // CM_TURN / CM_SITDOWN / CM_SPELL / CM_RUN 已移植（见各自的 …Tests），
    // 故**不再**出现在本早退名单里。只剩 CM_WALK 与攻击族。
    public void CheckUsePlugin_UnportedIdentFamilies_ReturnFalseWithoutSideEffects(ushort ident)
    {
        // ★ 本车道的**已知缺口**（原文 CM_WALK 3528-4696 与攻击族 6690-7888 未移植）：
