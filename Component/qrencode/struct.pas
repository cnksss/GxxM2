 ...
 *}
  ...
  TArrayInt5 = array[0..5-1] of Integer;

  TQRCodeGenerateParam = record
  nCaseSensitive:Integer;
  nEightBit: Integer;      //default 0
  nVersion: Integer;       //default 0
  nDotSize: Integer;       //default 4
  nMargin: Integer;        //ฑ฿ิต
  nDpi: Integer;           //default 72
  //nStructured: Integer;    //default 0
  nMicro: Integer;         //default 0 //MQR
  nLevel: QRecLevel;       //QR_ECLEVEL_L;
  qrmHint: QRencodeMode;   //QR_MODE_8;
  nForeColor:UInt;
  nBackColor:UInt;
end;
PQRCodeGenerateParam = ^TQRCodeGenerateParam;
