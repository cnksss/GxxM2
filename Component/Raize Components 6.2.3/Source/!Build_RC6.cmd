...
rem
rem     RAD Studio RX11.3 (Delphi RX11.3)   VCLVersion="28"	Path="Studio\22.0"
...
if %VCLVersion% == "12" set ProgPath=
if %VCLVersion% == "14" set ProgPath=RAD Studio\7.0
if %VCLVersion% == "15" set ProgPath=RAD Studio\8.0
if %VCLVersion% == "16" set ProgPath=RAD Studio\9.0
if %VCLVersion% == "17" set ProgPath=RAD Studio\10.0
if %VCLVersion% == "18" set ProgPath=RAD Studio\11.0
if %VCLVersion% == "19" set ProgPath=RAD Studio\12.0
if %VCLVersion% == "20" set ProgPath=Studio\14.0
if %VCLVersion% == "21" set ProgPath=Studio\15.0
if %VCLVersion% == "22" set ProgPath=Studio\16.0
if %VCLVersion% == "23" set ProgPath=Studio\17.0
if %VCLVersion% == "24" set ProgPath=Studio\18.0
if %VCLVersion% == "25" set ProgPath=Studio\19.0
if %VCLVersion% == "26" set ProgPath=Studio\20.0
if %VCLVersion% == "28" set ProgPath=Studio\22.0
...
rem set DCC32EXE="C:\Program Files (x86)\Embarcadero\Studio\22.0\Bin\DCC32.exe"
set DCC32EXE="C:\Program Files (x86)\Embarcadero\%ProgPath%\Bin\DCC32.exe"
...
set DCC64EXE="C:\Program Files (x86)\Embarcadero\%ProgPath%\Bin\DCC64.exe"
...
set IDE_Name=RAD Studio RX11.3
set PkgSuffix=280

set LibDir32=RX11.3\Win32
set LibDir64=RX11.3\Win64
set Compile64bit=True
set UnitScopeNames=-NSSystem;System.Win;Winapi;Vcl;Vcl.Imaging;Data;
