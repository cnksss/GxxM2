...
// (DO NOT EDIT: machine generated header) 'VirtualTreesD.dpk' rev: 35.00 (Windows)
...
#include <VTAccessibilityFactory.hpp>	// (VirtualTreesR)
...
namespace Virtualtreesd
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Virtualtreesd */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VIRTUALTREESD)
using namespace Virtualtreesd;
#endif
#pragma pack(pop)
#pragma option pop
