...
{$EXTERNALSYM _ftol}
procedure __ftol; cdecl; external; {$L static_obj\ftol.obj}
{$EXTERNALSYM __ftol}
procedure _ftoul; cdecl;
{$EXTERNALSYM _ftoul}
procedure __ftoul; cdecl; external; {$L static_obj\_ftoul.obj}
{$EXTERNALSYM __ftoul}
...
begin
  ...
  if not TryStrToFloat(s, Result) then
    ...
    endPtr^ := PAnsiChar(Integer(PByte(Value)) + Length(s));
end;
