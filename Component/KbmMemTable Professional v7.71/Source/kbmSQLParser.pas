...
const
	...
	SELECTSym = 21;	DISTINCTSym = 22;	ASSym = 23;	WHERESym = 24;	HAVINGSym = 25;
	ORDERSym = 26;	BYSym = 27;	GROUPSym = 28;	LIMITSym = 29;	OFFSETSym = 30;
	_lparenSym = 31;	_rparenSym = 32;	_starSym = 33;	_pointSym = 34;	NULLSym = 35;
	TRUESym = 36;	FALSESym = 37;	DESCSym = 38;	ASCSym = 39;	NOTSym = 40;
	ANDSym = 41;	ORSym = 42;	XORSym = 43;	_less_greaterSym = 44;	_lessSym = 45;
	_less_equalSym = 46;	_greaterSym = 47;	_greater_equalSym = 48;	INSym = 49;	LIKESym = 50;
	BETWEENSym = 51;	ISSym = 52;	_plusSym = 53;	_minusSym = 54;	_bar_barSym = 55;
	_slashSym = 56;	MODSym = 57;	DIVSym = 58;	_commaSym = 59;	_NOSYMB = 60;
	_slash_starSym = 61;	_slash_slashSym = 62;
...
const TokenStrings: array[0.._NOSYMB] of String = ('EOF'
	...
	,'"SELECT"'	,'"DISTINCT"'	,'"AS"'	,'"WHERE"'	,'"HAVING"'
	,'"ORDER"'	,'"BY"'	,'"GROUP"'	,'"LIMIT"'	,'"OFFSET"'
	,'"("'	,'")"'	,'"*"'	,'"."'	,'"NULL"'
	,'"TRUE"'	,'"FALSE"'	,'"DESC"'	,'"ASC"'	,'"NOT"'
	,'"AND"'	,'"OR"'	,'"XOR"'	,'"<>"'	,'"<"'
	,'"<="'	,'">"'	,'">="'	,'"IN"'	,'"LIKE"'
	,'"BETWEEN"'	,'"IS"'	,'"+"'	,'"-"'	,'"||"'
	,'"/"'	,'"MOD"'	,'"DIV"'	,'","'  ,'not');
...
begin
  case ErrorCode of
	...
	12 : Result := 'invalid FunctionExpr';
	13 : Result := 'invalid ConstExpr';
	14 : Result := 'invalid BinaryExpression';
	15 : Result := 'invalid Term';
...
begin
  ...
  begin
    ...
    begin
	  ...
	  States[42] := 20;  States[60] := 31;  States[62] := 32;  States[43] := 24;  States[45] := 25;
	  States[124] := 26;  States[44] := 28;
    end;
    kbmSQLParserLiterals := CreateLiterals(False,
	['UNION','ALL','UPDATE','SET','INSERT','INTO','VALUES','DELETE','FROM','EVAL','CALC','FILTER','SELECT','DISTINCT','AS'
		,'WHERE','HAVING','ORDER','BY','GROUP','LIMIT','OFFSET','NULL','TRUE','FALSE','DESC','ASC','NOT','AND','OR','XOR','IN'
		,'LIKE','BETWEEN','IS','MOD','DIV'],
	[UNIONSym,ALLSym,UPDATESym,SETSym,INSERTSym,INTOSym,VALUESSym,DELETESym,FROMSym,EVALSym,CALCSym,FILTERSym,SELECTSym
		,DISTINCTSym,ASSym,WHERESym,HAVINGSym,ORDERSym,BYSym,GROUPSym,LIMITSym,OFFSETSym,NULLSym,TRUESym,FALSESym,DESCSym,ASCSym
		,NOTSym,ANDSym,ORSym,XORSym,INSym,LIKESym,BETWEENSym,ISSym,MODSym,DIVSym]
     );
  end;
...
begin
  ...
  InitSymSets(kbmSQLParserSymSets,[
    	{ 0} _EOFSYMB, SQLStringSym, variableidentSym, identSym, funcidentSym, integer_Sym, floatSym, _semicolonSym, UNIONSym, ALLSym, UPDATESym, SETSym, _equalSym, INSERTSym, INTOSym, VALUESSym, DELETESym, FROMSym, EVALSym, CALCSym, FILTERSym, SELECTSym, DISTINCTSym, ASSym, WHERESym, HAVINGSym, ORDERSym, BYSym, GROUPSym, LIMITSym, OFFSETSym, _lparenSym, _rparenSym, _starSym, _pointSym, NULLSym, TRUESym, FALSESym, DESCSym, ASCSym, NOTSym, ANDSym, ORSym, XORSym, _less_greaterSym, _lessSym, _less_equalSym, _greaterSym, _greater_equalSym, INSym, LIKESym, BETWEENSym, ISSym, _plusSym, _minusSym, _bar_barSym, _slashSym, 
MODSym, DIVSym, _commaSym, _NOSYMB, -1,
	{ 1} _EOFSYMB, _semicolonSym, UNIONSym, _equalSym, VALUESSym, FROMSym, ASSym, WHERESym, HAVINGSym, ORDERSym, GROUPSym, LIMITSym, OFFSETSym, _rparenSym, _starSym, ANDSym, ORSym, XORSym, _less_greaterSym, _lessSym, _less_equalSym, _greaterSym, _greater_equalSym, INSym, LIKESym, BETWEENSym, ISSym, _plusSym, _minusSym, _bar_barSym, _slashSym, MODSym, DIVSym, _commaSym, -1,
	...
	{ 8} ALLSym, UPDATESym, SETSym, INSERTSym, INTOSym, VALUESSym, DELETESym, EVALSym, CALCSym, FILTERSym, SELECTSym, DISTINCTSym, BYSym, _pointSym, DESCSym, ASCSym, NOTSym, _NOSYMB
  ]); 
