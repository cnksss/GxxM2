...
uses
  Classes, Windows, SysUtils, DirectXGraphics, OpenJpeg, Graphics, D3DX81mo;
...
uses
  Messages, Math, MMSystem, ShellAPI, Types, ZLib, ZipUtils,
  UnZip;
