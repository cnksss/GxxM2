...
resourcestring
  ...
  SMyShopChangeItemFail12 = '[修改物品失败]：店铺物品禁止修改价格！';
  ...
  SGuildDelMemberFail4 = '退出行会失败'; //'不能使用命令Z！'; //HZQ 20230525
  ...
  SGuildRequestAllyRet7 = '不能和敌对行会或者联盟行会的敌对行会结盟。'; //HZQ 20230529 随M2同步增加
