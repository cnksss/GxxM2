...
type
  TfrmGeneralConfig = class(TForm)
    ...
    chkClientSoftVer: TCheckBox;
    edtClientSoftVer: TEdit;
    ...
    procedure chkClientSoftVerClick(Sender: TObject);
    procedure edtClientSoftVerChange(Sender: TObject);
  private
...
procedure TfrmGeneralConfig.chkClientSoftVerClick(Sender: TObject);
begin
  if not m_Showed then
    Exit;
  g_pConfig.m_boCheckVersion := chkClientSoftVer.Checked;
end;

procedure TfrmGeneralConfig.edtClientSoftVerChange(Sender: TObject);
begin
  if not m_Showed then
    Exit;
  g_pConfig.m_sClientSoftVer := edtClientSoftVer.Text;
end;
