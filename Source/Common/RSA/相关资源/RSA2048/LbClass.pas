...
type
  ...
  public {methods}
    ...
    function  DecryptString(const InString : AnsiString) : AnsiString; virtual; abstract;
    ...
    function  EncryptString(const InString : AnsiString) : AnsiString; virtual; abstract;
...
{ -------------------------------------------------------------------------- }
function TLbBlowfish.DecryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLbBlowfish.EncryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLbDES.DecryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLbDES.EncryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLb3DES.DecryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLb3DES.EncryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLbRijndael.DecryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
...
{ -------------------------------------------------------------------------- }
function TLbRijndael.EncryptString(const InString : AnsiString) : AnsiString;
begin
  case CipherMode of
