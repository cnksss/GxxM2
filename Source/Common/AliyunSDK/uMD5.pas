...
function EncodeMD5Str(Str: string): string;       //MD5 string
function EncodeMD5File(FileName: string): string; //MD5 file
...
function EncodeMD5Str(Str: string): string;
begin
  Result := MD5Print(MD5String(Str));
end;

function EncodeMD5File(FileName: string): string;
begin
