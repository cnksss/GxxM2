...
type
  ...
  function RivestBuffer(Buffer: PChar; Size: Int64): string;

  function MD5String(m: string): MD5Digest;
  function MD5Memory(Buffer: PChar; Size: Int64): MD5Digest;
  ...
  function StrToMD5Digest(S: string; var MD5: MD5Digest): Boolean;
...
function RivestBuffer(Buffer: PChar; Size: Int64): string;
begin
  Result := MD5Print(MD5Memory(Buffer, Size));
end;
...
begin
  ...
  begin
    ...
    for I := 0 to 15 do
    begin
      TempS := Copy(S, I * 2 + 1, 2);
      MD5[I] := StrToInt('$' + TempS);
    end;
  end;
end;
