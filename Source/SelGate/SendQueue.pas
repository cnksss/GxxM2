...
type
  ...
  public
    ...
    function AddBuffer(ComOBJ: PIOCPCommObj; const pInBuffer: PChar; const
      nSize: Integer): Integer;
    function AddBuffer2(ComOBJ: PIOCPCommObj; const pInBuffer: PChar; const
...
function TSendQueue.AddBuffer(ComOBJ: PIOCPCommObj; const pInBuffer: PChar; const
  nSize: Integer): Integer;
var
  PTRSendObj: PSendQueueNode;
  iSendLen: Integer;
...
function TSendQueue.AddBuffer2(ComOBJ: PIOCPCommObj; const pInBuffer: PChar;
  const nSize: Integer): Boolean;
var
  PTRSendObj: PSendQueueNode;
  iSendLen: Integer;
  QuerySend: Boolean;
...
procedure TSendQueue.FreeMemPoolRecvObj(const MemID: UINT; const MemBuffer:
  PAnsiChar);
var
...
begin
  ...
  else if bAddData and (pInBuffer <> nil) then
  begin
    //这时候缓冲区为空
