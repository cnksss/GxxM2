...
procedure DrawBackGround(G: TGPGraphics; R: TRect; IsDrawNoise: Boolean);
var
  HB: TGPHatchBrush;
begin
...
procedure MakeVerifyCode(Code: string; Bitmap: TBitmap; Font: TFont; WaveValue: Integer; DrawNoise: Boolean; InflateRectValue: Integer);
var
  G: TGPGraphics;
begin
  ...
  try
    G.SetSmoothingMode(SmoothingModeAntiAlias);
    DrawBackGround(G, Bitmap.Canvas.ClipRect, DrawNoise);
