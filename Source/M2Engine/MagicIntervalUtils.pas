...
type
  ...
  public
    ...
    procedure Clear;
    function Add(MagicID: Word): PMagicInterval; overload;
    function Add(MagicID: Word; CDTime: LongWord): PMagicInterval; overload;
...
function TMagicIntervalList.Add(MagicID: Word; CDTime: LongWord): PMagicInterval;
var
  I: Integer;
begin
  Result := nil;
