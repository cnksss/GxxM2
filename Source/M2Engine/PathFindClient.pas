...
uses
  Windows, Classes, SysUtils, Graphics, Math, Grobal2;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (nDir0 = nDir1) and (nDir1 = nDir2) then
          begin
            WalkPath[I - 2].x := -1;
            WalkPath[I - 2].y := -1;
...
begin
  with TFindPathThread.Create(StartX, StartY, StopX, StopY) do
  begin
    FExcludeMonster := ExcludeMonster;
  end;
end;
